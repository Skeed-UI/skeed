...
const variantClasses: Record<NonNullable<CalloutProps['variant']>, string> = {
  ...
  success:
    'bg-skeed-color-success-50 border-l-skeed-color-success-500 text-skeed-color-success-800',
  warning:
    'bg-skeed-color-warning-50 border-l-skeed-color-warning-500 text-skeed-color-warning-800',
...
export const Callout = forwardRef<HTMLDivElement, CalloutProps>(function Callout(
  ...
  return (
    <div
      ...
      {...rest}
    >
      {title && <p className="font-medium font-skeed-body mb-skeed-spacing-1">{title}</p>}
