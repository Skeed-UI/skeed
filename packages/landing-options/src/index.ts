import { ARCHETYPES, type LandingArchetype, type SubVariant, applyVariant } from './archetypes.js';
...
export function generateLandingCandidates(opts: GenerateOptions): LandingCandidate[] {
  ...
  const variants: SubVariant[] = opts.includeWaitlist
    ? ['actual-landing', 'waitlist-teaser']
    : ['actual-landing'];
