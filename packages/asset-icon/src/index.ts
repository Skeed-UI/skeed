// Icon components for Skeed UI
export type { IconProps, IconComponent, IconWeight, IconVariant } from './types';
...
export { Spinner, type SpinnerProps, type SpinnerVariant } from './icons/spinner';
